...
/// custom exit dialog
Future<String?> exitDialog({required context, required contentKey}) async {
            ...
            children: <Widget>[
              ...
              AnimatedOnTapButton(
                ...
                child: Text(
                  'Discard',
                  style: TextStyle(
                      fontSize: 16, color: Colors.redAccent.shade200, fontWeight: FontWeight.bold, letterSpacing: 0.1),
                  textAlign: TextAlign.center,
                ),
              ),
              const SizedBox(
              ...
              AnimatedOnTapButton(
                onTap: () async {
                  ...
                  if (_paintingProvider.lines.isNotEmpty || _widgetProvider.draggableWidget.isNotEmpty) {
                    ...
                    if (response != null) {
                      _dispose(context: context, message: 'Successfully saved', value: response);
                    } else {
...
_dispose({required context, required message, String? value}) {
  _resetDefaults(context: context);
